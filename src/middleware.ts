...
export function middleware(req: NextRequest) {
    ...
    const protectedRoutes = ["/dashboard", "/perfil", "/agendamentos", "/barbeiros", "/barbearia"];
...
export const config = {
    matcher: ["/", "/dashboard/:path*", "/perfil/:path*", "/login", "/register", "/agendamentos", "/barbeiros", "/barbearia"], // Protege essas rotas
};
